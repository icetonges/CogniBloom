      ...
      <div ref={splitContainerRef} className="flex flex-1 overflow-hidden">
        ...
        {showSidebar && (
          <div
            ...
            className="hidden lg:flex w-1.5 flex-shrink-0 cursor-col-resize items-center justify-center group relative z-10"
            style={{ background: 'rgba(255,255,255,0.03)' }}
            title="Drag to resize"
          >
            <div className="w-0.5 h-12 rounded-full bg-white/10 group-hover:bg-primary/60 group-active:bg-primary transition-colors" />
          </div>
        )}
        ...
        {showSidebar && (
          <div
            ...
            style={{ width: `${100 - leftPct}%`, background: 'rgba(0,0,0,0.15)', flexShrink: 0 }}
          >
            {/* Sidebar tabs */}
            <div
